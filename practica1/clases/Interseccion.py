...
class Interseccion:
    ...
    def distancia_curva(self, otra_interseccion):
        """
        Calcula la distancia entre esta intersección y otra, en kilómetros.
        ...
        # grados a radianes
        lon1, lat1, lon2, lat2 = map(radians, [self.longitude, self.latitude, otra_interseccion.longitude,
                                               otra_interseccion.latitude])
